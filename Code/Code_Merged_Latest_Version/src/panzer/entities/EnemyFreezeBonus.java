 ...
 */
public class EnemyFreezeBonus extends Bonus{
    ...
    public EnemyFreezeBonus(boolean _isAlive, double _coordinateX, double _coordinateY, int width, int height) {
        ...
        setCustomImg( new Image(Panzer2017.class.getResource("images/power_freeze.png").toExternalForm(),38,38,false,false));
