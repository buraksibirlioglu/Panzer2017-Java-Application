 ...
 */
public class ProtectionBonus extends Bonus{
    ...
    public ProtectionBonus(boolean _isAlive, double _coordinateX, double _coordinateY, int width, int height) {
        ...
        setCustomImg( new Image(Panzer2017.class.getResource("images/power_shield.png").toExternalForm(),38,38,false,false));
