    ...
    public void initialize(URL url, ResourceBundle rb) { 
        ...
        play.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent e) {  
                    if(firstTime) { on_or_off = GameEngine.soundOnOrOff; firstTime = false;}
                    if (position == 0){
                        if (e.getCode()== KeyCode.DOWN){
                            play.setImage(new Image(Panzer2017.class.getResource(CONTINUE_NOT_PRESSED).toExternalForm()));   
                            if(on_or_off){
                        ...
                        if (e.getCode()== KeyCode.DOWN){
                            exit.setImage(new Image(Panzer2017.class.getResource(EXIT_PRESSED).toExternalForm()));   
                            if(on_or_off){
                            ...
                            play.setImage(new Image(Panzer2017.class.getResource(CONTINUE_PRESSED).toExternalForm()));   
                            if(on_or_off){
                                son_off_btn.setImage(new Image(Panzer2017.class.getResource(SOUND_NOT_PRESSED_ON).toExternalForm()));   
                            }else{
                                son_off_btn.setImage(new Image(Panzer2017.class.getResource(SOUND_NOT_PRESSED_OFF).toExternalForm()));   
                            ...
                            GameEngine.soundOnOrOff = on_or_off;
                            if(on_or_off){
                                son_off_btn.setImage(new Image(Panzer2017.class.getResource(SOUND_PRESSED_ON).toExternalForm()));   
                            }else{
                                son_off_btn.setImage(new Image(Panzer2017.class.getResource(SOUND_PRESSED_OFF).toExternalForm()));   
                        ...
                        if (e.getCode()== KeyCode.DOWN){
                            play.setImage(new Image(Panzer2017.class.getResource(CONTINUE_PRESSED).toExternalForm()));   
                            exit.setImage(new Image(Panzer2017.class.getResource(EXIT_NOT_PRESSED).toExternalForm()));   
